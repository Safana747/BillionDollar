...
import SuccessAlertForPaymentGatway from "./SuccessAlertForPaymentGateway";
...
console.log(sIndex,"sssssaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
  ...
  useEffect(() => {
    console.log('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!');
    console.log(userPrefferedPayMethod,'userPrefferedPayMethod');
    console.log('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!');
    if(userPrefferedPayMethod) setSuccess("Pixel has been added  for purchase now its the time for payment....");
    setTimeout(() => {
  ...
  return (
    <div className="w-full mt-2 mb-5">
      {success && <SuccessAlertForPaymentGatway closeHandler={() => setSuccess(null)} />}
